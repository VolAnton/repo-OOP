...
namespace Lesson_7
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            mes.ShowMessage($"Опрос состояния точки (видимый/невидимый): {p1.IsVisible}");
            mes.SkippingLines(1);
            ...
            mes.ShowMessage($"Опрос состояния круга (видимый/невидимый): {c1.IsVisible}");
            mes.SkippingLines(1);
            
            
            mes.ShowMessage($"--==Фигура прямоугольник==--");
            
            mes.ShowMessage($"Создаём прямоугольник");
            ...
            mes.ShowMessage($"Опрос состояния прямоугольника (видимый/невидимый): {r1.IsVisible}");
